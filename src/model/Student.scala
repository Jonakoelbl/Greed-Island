...
case class Student (aName: String, aLastname: String, anAge: Int, currentCareer: Career) 
	...
	var subjects : List[(Subject, Boolean, Int)] = List() //Should not have repeated
...
//	TODO def porcentaje de cursos aprobados sobre cursos iniciados
